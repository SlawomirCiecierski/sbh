        ...
        switch (s) {
            case BYDGOSZCZ_1920:
                if (to.size() == 0)
                {
                    ...
                    to.add("Po I wojnie światowej Bydgoszcz uległa bardzo szybkiej repolonizacji i stała się jednym z najbardziej polskich miast (około 1928/1929 Polacy stanowili 92% populacji miasta, natomiast przed repolonizacją, pod zaborami, w 1910 Polaków było około 19% według oficjalnego spisu oraz 28% według korekty Eugeniusza Romera).");
                    to.add("W 1920 ośmiokrotnie powiększono obszar miasta, włączając w nie polskie przedmieścia, a jego granice na wschodzie przekroczyły Wisłę.");
                    to.add("W 1928 Bydgoszcz stała się węzłem oraz siedzibą dyrekcji nowo zbudowanej kolejowej magistrali węglowej Śląsk-Gdynia");
                    to.add("W międzywojennej Bydgoszczy kontynuowała działalność m.in. Biblioteka Miejska (zał. 1903), powstało Muzeum Miejskie (1923), Miejska Orkiestra Symfoniczna (1936). Centrum sportów wodnych w kraju był tor regatowy w Brdyujściu.");
            ...
            case BYDGOSZCZ_1945:
                if (to.size() == 0)
                {
                    ...
                    to.add("30 sierpnia następuje powołanie na wniosek Witolda Bełzy Komitetu Obchodów 600-lecia miasta Bydgoszczy powiązanych z Pomorską Wystawą Przemysłu, Rzemiosła i Handlu; ustalenie planu odbudowy i rozbiórek wypalonych budynków (w tym Teatru Miejskiego) oraz rozwoju placówek kulturalnych.");
                    ...
                    to.add("Uruchomienie Wojskowych Zakładów Lotniczych nr 2; w mieście znajduje się 209 zakładów przemysłowych, w tym część czeka na uruchomienie.");
                    ...
                    to.add("W marcu 1945, po zainicjowaniu tworzenia polskiej administracji państwowej, w Bydgoszczy ulokowano stolicę województwa pomorskiego, nie zaś w Toruniu, argumentując to przede wszystkim dwukrotnie większym potencjałem demograficznym, kluczowym dla nowej władzy ludowej. Uwzględniono przy tym również argumenty o rodowodzie przedwojennym, tzn. potencjał gospodarczy i dostępność komunikacyjną.");
                }
                listRandomIndex = (int) (Math.random() * to.size());
                return to.get(listRandomIndex);


            case MARIAN_REJEWSKI:

                if (to.size() == 0) {
                    to.add("W niedzielę, 10 grudnia 2017. po raz pierwszy w trasę z Bydgoszczy do Warszawy wyruszył pociąg IC Rejewski, nazwany na cześć słynnego bydgoskiego matematyka - Mariana Rejewskiego.Z okazji inauguracyjnego kursu PKP Intercity przygotowało dla pasażerów edukacyjną akcję - łamigłówki logiczne, materiały informacyjne o kryptologu oraz słodki poczęstunek. W uroczystym przejeździe pociągu udział wzięła córka Mariana Rejewskiego - Pani Janina Sylwestrzak, a na dworcu w Bydgoszczy pojawił się dr Krzysztof Osiński - pracownik naukowy zajmujący się kryptologią.");

                    to.add("Za rozwiązanie szyfru maszynowego Enigma Rejewski został odznaczony Złotym Krzyżem Zasługi, natomiast za działalność we Francji w warunkach konspiracyjnych przyznano mu Srebrny Krzyż Zasługi z Mieczami. Kryptolog otrzymał także nominację na podporucznika w Korpusie Oficerów Łączności, a po kilku miesiącach awans na porucznika. Dla uhonorowania dokonań polskich matematyków i kryptologów, 25 stycznia obchodzony jest Dzień Kryptologii.");

                    to.add("Marian Rejewski był postacią tragiczną; po II wojnie św. ten wybitny matematyk, który złamał szyfr Enigmy, pracował w bydgoskiej firmie, gdzie jego potencjał nie mógł być wykorzystany - powiedział PAP Maciej Jasiński, twórca scenariusza do komiksu o Rejewskim.");

                    to.add("Wydarzyło się całe pasmo zdarzeń, które doprowadziły do zapomnienia tej postaci, a także podważenia dorobku Rejewskiego. Po zakończeniu wojny, gdy przebywał jeszcze w Wielkiej Brytanii, był ostrzegany, że po powrocie do kraju mogą go czekać niemiłe konsekwencje jako osobę, która przed wojną współpracowała z wywiadem. Postanowił jednak wrócić ze względu na rodzinę, którą pozostawił w Polsce. Po powrocie do Polski pierwsze kroki skierował do Bydgoszczy, gdzie znajdowali się jego krewni. W momencie, gdy wysiadał ze statku, żołnierze pilnujący portu zapytali go wprost, po co wracał.");

                    to.add("W Polsce powojennej geniusz matematyczny, którym był Rejewski, starał się o przyjęcie na jakąkolwiek uczelnię jako wykładowca. Nie znalazł jednak nigdzie zatrudnienia.");

                    to.add("Rejewski, jako jedyny z zespołu Enigmy, wrócił po wojnie w 1946 r. z Wielkiej Brytanii do Polski, gdzie czekała na niego żona i dwójka dzieci. Do emerytury pracował w bydgoskich zakładach na podrzędnych stanowiskach. Prawdę o swych dokonaniach ujawnił w napisanych w 1967 r. wspomnieniach. Rola Polaków w rozwiązaniu tajemnic Enigmy nabrała szerszego rozgłosu dopiero po wydaniu na początku lat 70. wspomnień francuskiego oficera wywiadu i kryptologa Gustave'a Bertranda.");

                    to.add("Rejewski Marian Adam, pseud. Pierre Ranaud (1905–1980), matematyk, kryptolog, autor rozwiązania niemieckiego szyfru maszynowego Enigma. Ur. 16.08 w Bydgoszczy, był najmłodszym spośród siedmiorga dzieci Józefa, kupca tytoniowego, i Matyldy z domu Thoms");

                    to.add("Po zdaniu matury w gimnazjum klasycznym w Bydgoszczy (1923), R. odbył studia matematyczne na Uniw. Pozn. i uzyskał stopień magistra filozofii (1929). W l. 1929–30 specjalizował się na uniwersytecie w Getyndze w zagadnieniach matematyki ubezpieczeniowej. W l. 1930–32 był młodszym asystentem w Instytucie Matematycznym Uniw. Pozn. u Zdzisława Krygowskiego. Jednocześnie powołano go do współpracy w poznańskiej ekspozyturze Biura Szyfrów Sztabu Głównego WP, utajnionej komórki wywiadowczo-informacyjnej dla potrzeb rozpoznania sytuacji Polski w odniesieniu do działań państw ościennych, głównie Niemiec.");

                    to.add("Był najmłodszym z siedmiorga rodzeństwa, nosił okulary i cechowała go powaga wyglądu i zachowania. Nieco nieśmiały, w naturalny sposób nadawał się na poznański kurs kryptologii… był już jednak jego absolwentem. W roku 1929, gdy kurs się rozpoczynał, Rejewski miał 23 lata, za sobą obronę pracy magisterskiej zatytułowanej Opracować teorię funkcji podwójnie periodycznych drugiego i trzeciego rodzaju oraz jej zastosowanie i nie był już studentem. Planował rozpocząć pracę na wydziale profesora Krygowskiego – co istotnie wróżyło karierę szpiega. Przede wszystkim jednak przyszły matematyk musiał wyjechać na dwuletnie studia pomagisterskie do Getyngi. Getynga była mekką dwudziestowiecznych matematyków i fizyków. Przebywali tam tacy mistrzowie, jak Hilbert, Born, Courant, Heisenberg, Wigner, von Neumann i inni.");

                    to.add("Mimo dobrych perspektyw na karierę akademicką Rejewski trafił do łamania szyfrów. Profesor Krygowski został poproszony o wskazanie najlepszych kandydatów na kurs kryptologii. Rejewski był wyraźnie najlepszy (był też dwujęzyczny, co było spadkiem po dzieciństwie spędzonym w rządzonej przez Niemców Wielkopolsce). Dlatego, niezależnie od wcześniejszych studiów, a może właśnie dzięki temu, że obronił już pracę magisterską, a zajęcia w Getyndze miały rozpocząć się dopiero za kilka miesięcy, Rejewski przystąpił do nowego kursu. A ponieważ był Marianem Rejewskim, ukończył go, jako jedyny, z wyróżnieniem.");

                    to.add("Historycy są zgodni, że „gest Polaków wobec sojuszników stanowi ważny wkład w tajną walkę z nazistami”, a Rejewskiego należy uznać za „pioniera wśród tych, którzy ujawnili sekrety Enigmy, nawet jeśli to innym, w Wielkiej Brytanii i Francji, przypadło w udziale kontynuowanie i wykorzystanie jego osiągnięć");
                    to.add("Niemcy stale modyfikowali Enigmę, m.in. zwiększając liczbę wirników. Swoje prace kontynuowali również pracownicy Biura Szyfrów Oddziału II Sztabu Głównego Wojska Polskiego. W 1938 roku Rejewski zaprojektował pierwszą bombę kryptologiczną, która zautomatyzowała proces deszyfrowania przechwytywanych wiadomości i umożliwiła ich odczytywanie na masową skalę. Replika tego przełomowego dla losów konfliktu urządzenia została w marcu 2018 roku umieszczona na wystawie w Bletchley Park.");

                    to.add("Pierwszym krokiem, który podjął Rejewski w celu złamania kodu Enigmy była próba rekonstrukcji najważniejszego elementu maszyny, wirników kodujących. W tym celu jako pierwszy zastosował do kryptoanalizy czysto matematyczne metody. Wcześniej w łamaniu szyfrów wykorzystywano metody lingwistyczne i statystyczne dla języka naturalnego, oraz analizę częstościową występowania poszczególnych znaków w tekście danego języka.");
                    to.add("Na początku 1933 roku, w czasie, gdy Rejewski pracował nad wyliczeniem schematu uzwojeń pozostałych wirników, dołączyli do niego Różycki i Zygalski w celu opracowania metod i narzędzi do rutynowego łamania kodów Enigmy. Chociaż wywiad francuski dostarczył do Biura Szyfrów kolejne zestawy ustawień, to nigdy nie zostały one przekazane Rejewskiemu i jego kolegom. Prawdopodobnie stało się tak, dlatego, aby polscy matematycy opracowali własne, niezależne od Francuzów metody, które by pozwoliły odczytywać szyfrogramy także w przypadku braku kodów zdobywanych metodami wywiadowczymi.");

                    to.add("W latach 1949–1958 Rejewski był inwigilowany przez Urząd Bezpieczeństwa Publicznego i Służbę Bezpieczeństwa, ale ponieważ był on człowiekiem spokojnym i ostrożnym, a także bardzo dyskretnym, poza faktem jego pracy w Biurze Szyfrów Oddziału II Sztabu Głównego Wojska Polskiego nie było wiadomo prawie nic na temat jego wojennych losów i pracy nad Enigmą.");

                    to.add("Krótko po przejściu na emeryturę Rejewski napisał wspomnienia, w których ujawnił swój udział w złamaniu najtajniejszego niemieckiego szyfru i których rękopis zdeponował w ówczesnym Wojskowym Instytucie Historycznym. W 1969 M. Rejewski wraz z rodziną przeprowadził się do Warszawy.");

                    to.add("Aula w Instytucie Matematyki Uniwersytetu Kazimierza Wielkiego w Bydgoszczy nosi od 23 stycznia 2006 roku imię Mariana Rejewskiego. Znajduje się w niej kopia rzeźby autorstwa Michała Kubiaka przedstawiającej matematyka. Oryginalna rzeźba znajduje się w Bydgoszczy na skrzyżowaniu ulicy Gdańskiej z ulicą Śniadeckich.");
                    to.add("Poczta Polska, chcąc uczcić dokonania Polaków na świecie, wprowadziła w roku 2009 do obiegu cztery znaczki. Na znaczku o nominale 1,95 zł przedstawiono podobiznę Mariana Rejewskiego w otoczeniu pozostałych odtwórców Enigmy.");

                    to.add("Na wniosek Kontrwywiadu Dowództw Sojuszniczych NATO pośmiertnie przyznane zostało Marianowi Rejewskiemu Odznaczenie Knowltona. Odznaczenie zostało wprowadzone w 1995 roku przez Związek Korpusów Wywiadu Wojskowego Armii USA (US Army Military Intelligence Corps Association) i nazwane imieniem pioniera wywiadu Armii USA – pułkownika Thomasa Knowltona. Ustanowione w celu wyróżnienia osób, które wniosły znaczący wkład w osiągnięcia i sukcesy Wywiadu Wojskowego.");

                    to.add("5 sierpnia 2014 Międzynarodowe stowarzyszenie inżynierów IEEE uhonorowało prestiżowym wyróżnieniem Milestone trzech polskich matematyków: Mariana Rejewskiego, Jerzego Różyckiego i Henryka Zygalskiego za złamanie kodów niemieckiej maszyny szyfrującej Enigma. „To był kamień milowy o ogromnym znaczeniu, właściwie jeden z niewielu, który uratował ludzkie życie. Osiągnięcia techniczne zazwyczaj przyczyniają się do rozwoju przemysłu, służą rozrywce czy komunikacji. Ten uratował ludzkie życie” – podkreślił prezes The Institute of Electrical and Electronics Engineers (IEEE) prof. Roberto de Marca podczas uroczystości na Politechnice Warszawskiej. „Kamieniami milowymi” uhonorowano dotychczas ok. 120 naukowców, honorowane nim są te osiągnięcia naukowe, bez których świat wyglądałby inaczej.");

                    to.add("Cyklometr (z greckiego: κύκλος (cyclos) 'cykle' oraz μέτρον (metron) 'mierzyć') – urządzenie wynalezione przez polskiego matematyka i kryptologa Mariana Rejewskiego, służące do wyliczania cyklicznych permutacji szyfrogramów niemieckiej maszyny szyfrującej Enigma.");
