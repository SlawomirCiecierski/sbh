...
public class BydgoszczRandomToast {

    private static final LinkedList<String> to = new LinkedList<>();

    public static void showBydgoszczRandomToast(View view) {
        ...
        Toast randomBydgoszczToast = Toast.makeText(view.getContext(),
                to.get(listRandomIndex),
                Toast.LENGTH_LONG);
        randomBydgoszczToast.show();
    }
}
